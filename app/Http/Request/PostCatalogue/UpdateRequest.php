<?php
namespace App\Http\Request\PostCatalogue;
...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'admin_id' => 'nullable',
            'canonical' => "required|exists:post_catalogues:canonical:{$this->id}",
    ...
    public function messages(string $field, string $rule): string
    {
        $customMessages = [
            ...
            "exists:post_catalogues:canonical:{$this->id}" => "Đường dẫn này đã tồn tại, vui lòng thử đường dẫn khác"
        ];
