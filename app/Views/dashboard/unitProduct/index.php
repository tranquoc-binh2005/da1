...
<div class="card-box">
    <form action="" method="GET">
        <div class="filter-box">
            <a class="btn btn-info" href="/dashboard/unit_products/create">Thêm mới</a>
    ...
    <div class="table-responsive">
        <table class="table mb-0">
            ...
            <?php if(empty($unitProducts['data'])){?>
                <tr>
                    <td class="text-center" colspan="5">Không có bản ghi phù hợp</td>
                </tr>
            <?php }?>

            <?php foreach ($unitProducts['data'] as $unit) {?>
            <tr>
                <td class="text-left" width="350px">
                    <?=$unit['name']?> <br>
                </td>
                <td><?= $unit['value'] . ($unit['unit']) ?: 'Chưa cập nhật' ?></td>
                <th class="text-center">
                    <input type="checkbox"
                        <?=$unit['publish'] === 1 ? 'checked' : ''?>
                           ...
                           data-field="unit_products"
                           data-id="<?=$unit['id']?>"
                           data-column="publish"
                           data-publish="<?=$unit['publish']?>">
                </th>
                <th class="text-center">
                    <a style="font-size: 20px;" href="/dashboard/unit_products/show/<?=$unit['id']?>"><i class="fe-edit"></i></a>
                    <a style="font-size: 20px; color:rgb(241, 55, 55);" href="/dashboard/unit_products/delete/<?=$unit['id']?>"><i class="fe-trash"></i></a>
                </th>
            </tr>
            <tr>
            </tr>
