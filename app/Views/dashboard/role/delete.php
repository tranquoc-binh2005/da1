<div class="card-body row">
    <div class="col-md-6">
        ...
        <p class="text-muted font-13">
            Bạn có muốn xoá nhóm vai trò <span class="text-danger"><?= $role['name']?></span> này không ?
        </p>
    ...
    <form action="/dashboard/roles/destroy/<?= $role['id'] ?? null ?>" method="POST" class="col-md-6">
        <div class="form-row">
