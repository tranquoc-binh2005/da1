<div class="ibox-content">
    <div class="seo-container">
        <div class="meta_title">
            <h3><?= isset($product) ? $product['meta_title'] : old('meta_title')?></h3>
        </div>
        <div class="canonical">
            <?=BASE_URL?><?=isset($product) ? $product['canonical'] : old('canonical')?><?=SUFFIX?>
        </div>
    ...
    <div class="seo-wrapper">
        ...
        <div class="col-md-12">
            ...
            <input
                ...
                value = "<?= isset($product) ? $product['meta_keyword'] : old('meta_keyword')?>"
            >
        </div>
        ...
        <div class="col-md-12">
            ...
            <input
                ...
                name="canonical"
                value = "<?= isset($product) ? $product['canonical'] : old('canonical')?>"
            >
