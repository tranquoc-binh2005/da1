...
<div class="card-box">
    <form action="" method="GET">
        <div class="filter-box">
            <a class="btn btn-info" href="/dashboard/admins/create">Thêm mới</a>
            ...
            <div class="mr-2">
                <select name="role_id" class="form-control">
                    <?php $oldRoleId = urldecode(old('role_id')) ?? "";?>
    ...
    <div class="table-responsive">
        <table class="table mb-0">
            ...
            <tr>
                <td class="col-info text-left" width="350px">
                    <img class="avata" loading="lazy" width="100px" src="<?=$admin['image'] ?? "/public/assets\images\users\user-3.jpg"?>" alt="">
                    <p class="information">
                        Họ tên: <?=$admin['name']?> <br>
                        Người tạo: <?=$admin['admin_name']?> <br>
                    </p>
                </td>
                <td><?= $admin['bio'] ?: 'Chưa cập nhật' ?></td>
                <td>
                    Địa chỉ: <?= $admin['address'] ?: 'Chưa cập nhật' ?> <br>
                    Email: <?=$admin['email']?> <br>
                    Vai trò: <?=$admin['role_name']?>
                </td>
                <th class="text-center">
                    <input type="checkbox"
                           <?=$admin['publish'] === 1 ? 'checked' : ''?>
                           ...
                           data-id="<?=$admin['id']?>"
                           data-column="publish"
                           data-publish="<?=$admin['publish']?>">
                </th>
                <th class="text-center">
                    <a style="font-size: 20px;" href="/dashboard/admins/show/<?=$admin['id']?>"><i class="fe-edit"></i></a>
                    <a style="font-size: 20px; color:rgb(241, 55, 55);" href="/dashboard/admins/delete/<?=$admin['id']?>"><i class="fe-trash"></i></a>
                </th>
            </tr>
            <tr>
            </tr>
        ...
        <?php if(isset($admins['data']) && !empty($admins['data'])){?>
