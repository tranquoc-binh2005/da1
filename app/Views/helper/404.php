...
<head>
    ...
    <style>
        body {
            /*background: linear-gradient(135deg, #f8f9fa, #e9ecef); !* Gradient nền *!*/
            height: 100vh;
            display: flex;
...
<div class="error-container animate__animated animate__fadeIn">
    <h1 class="error-code animate__animated animate__wobble">404</h1>
    <p class="error-message animate__animated animate__pulse">
        <?= $message ?? "Trang này lạc trôi vào hư không rồi!"?>
    </p>
