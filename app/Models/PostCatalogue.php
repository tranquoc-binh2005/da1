...
class PostCatalogue
{
    protected string $table = 'post_catalogues';
    protected array $getField = ['tb1.name', 'tb1.canonical', 'tb1.description', 'tb1.level', 'tb1.image', 'tb1.parent_id', 'tb1.publish', 'tb1.id'];
